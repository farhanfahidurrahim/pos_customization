...
//  ddelete package
    $(document).on('click', 'button.delete_package_button', function() {
        swal({
            title: LANG.sure,
            text: LANG.confirm_delete_brand,
            icon: 'warning',
    ...
    var contact_table = $('#contact_table').DataTable({
        ...
        fnDrawCallback: function(oSettings) {
            ...
            var total_contact_balance = sum_table_col($('#contact_table'), 'contact_balance');
            $('#footer_contact_return_due').text(total_return_due);
            $('#footer_contact_balance').text(total_contact_balance);
    ...
    expense_table = $('#expense_table').DataTable({
        ...
        fnDrawCallback: function(oSettings) {
            ...
            var total_paid = sum_table_col($('#expense_table'), 'amount_paid');
    ...
    $('select#type, select#location_id, select#expense_for, select#expense_category_id, select#expense_payment_status').on(
        'change',
        function() {
            expense_table.ajax.reload();
        }
