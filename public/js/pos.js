$(document).ready(function() {
    ...
    $('select#product_category, select#product_brand, select#combo_id').on('change', function(e) {
...
$(document).on('blur','input#tax_calculation_amount', function(){
...
function calculate_billing_details(price_total) {
    ...
    var order_tax  = parseFloat($('input#tax_calculation_amount').val());
