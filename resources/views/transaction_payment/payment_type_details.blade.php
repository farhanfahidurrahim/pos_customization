...
<div class="payment_details_div @if( $payment_line->method !== 'bkash' ) {{ 'hide' }} @endif" data-type="bkash" >
	<div class="col-md-12">
		<div class="form-group">
			{!! Form::label("transaction_no_5",__('Bkash Number')) !!}
			{!! Form::text("transaction_no_5", $payment_line->transaction_no, ['class' => 'form-control', 'placeholder' => __('Bkash Number')]); !!}
		</div>
	</div>
</div>
...
<div class="payment_details_div @if( $payment_line->method !== 'rocket' ) {{ 'hide' }} @endif" data-type="rocket" >
	<div class="col-md-12">
		<div class="form-group">
			{!! Form::label("transaction_no_6",__('Rocket Number')) !!}
			{!! Form::text("transaction_no_6", $payment_line->transaction_no, ['class' => 'form-control', 'placeholder' => __('Rocket Number')]); !!}
		</div>
	</div>
</div>
...
<div class="payment_details_div @if( $payment_line->method !== 'nogod' ) {{ 'hide' }} @endif" data-type="nogod" >
	<div class="col-md-12">
		<div class="form-group">
			{!! Form::label("transaction_no_7",__('Nogod Number')) !!}
			{!! Form::text("transaction_no_7", $payment_line->transaction_no, ['class' => 'form-control', 'placeholder' => __('Nogod Number')]); !!}
		</div>
	</div>
</div>
...
<div class="payment_details_div @if( $payment_line->method !== 'advance' ) {{ 'hide' }} @endif" data-type="advance" >
	<div class="col-md-12">
		<div class="form-group">
			{!! Form::label("transaction_no_7",__('Transaction Number')) !!}
			{!! Form::text("transaction_no_8", $payment_line->transaction_no, ['class' => 'form-control', 'placeholder' => __('Transaction Number')]); !!}
		</div>
	</div>
</div>
