    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title no-print">@lang('purchase.view_payments')
                (@if (in_array($transaction->type, ['purchase', 'income', 'expense', 'purchase_return']))
        ...
        <div class="modal-body">
                ...
                <div class="row invoice-info">
                    ...
                    <div class="col-md-4 invoice-col">
                        ...
                        <address>
                            ...
                            @endif
                            @if (
                                !empty($transaction->location->city) ||
            ...
            @elseif($transaction->type == 'expense' || $transaction->type == 'income')
                <div class="row invoice-info">
            ...
            @can('send_notification')
                    ...
                    <div class="row no-print">
                        <div class="col-md-12 text-right">
                            <button type="button" class="btn btn-info btn-modal btn-xs"
                                data-href="{{ route('notification.getTemplate', ['transaction_id' => $transaction->id, 'template_for' => 'payment_paid']) }}"
                ...
                @if ($transaction->type == 'sell')
                    <div class="row no-print">
                        <div class="col-md-12 text-right">
                            <button type="button" class="btn btn-info btn-modal btn-xs"
                                data-href="{{ route('notification.getTemplate', ['transaction_id' => $transaction->id, 'template_for' => 'payment_received']) }}"
                            ...
                            @if ($transaction->payment_status != 'paid')
                                ...
                                <button type="button" class="btn btn-warning btn-modal btn-xs"
                                    data-href="{{ route('notification.getTemplate', ['transaction_id' => $transaction->id, 'template_for' => 'payment_reminder']) }}"
                ...
                <div class="row">
                    <div class="col-md-12">
                        @if (
                            ...
                            <a href="{{ route('payments.addPayment', [$transaction->id]) }}"
                    ...
                    <table class="table table-striped">
                        ...
                        @forelse ($payments as $payment)
                            <tr>
                                ...
                                <td>{{ $transaction->contact->vat_number }}</td>
                                <td>{{ $transaction->contact->gst_number }}</td>
