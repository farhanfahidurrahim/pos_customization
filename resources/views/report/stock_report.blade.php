...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => route('report.getStockReport'), 'method' => 'get', 'id' => 'stock_report_filter_form' ]) !!}
                <div class="col-md-3">
    ...
    <div class="row">
        <div class="col-md-12" id="closing_amount">
...
@section('javascript')
    ...
    <script>
        $(document).ready(function(){
            ...
            $.ajax({
                url: '{{ route("report.closingStockAmount") }}',
                type: 'get',
                data: {},
                dataType: 'json',
                success: function(res){

                    $('#closing_amount').html(res.view);
