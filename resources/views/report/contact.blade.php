...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            {!! Form::open(['url' => route('report.getCustomerSuppliers'), 'method' => 'get', 'id' => 'customer_supplier_report_filter_form' ]) !!}
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('customer_group_id',  __('Customer Group Name') . ':') !!}
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('type', $types, null, ['class' => 'form-control select2', 'style' => 'width:100%']); !!}
