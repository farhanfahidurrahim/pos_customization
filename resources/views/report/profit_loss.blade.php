    ...
    <div class="row">
        <div class="col-xs-6">
            @component('components.widget')
                <table class="table table-striped">
                    <tr>
                        <th>{{ __('report.opening_stock') }} (By Purchase Price):</th>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="opening_stock_by_sell">
                                <i class="fa fa-refresh fa-spin fa-fw"></i>
                            </span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                             <span class="total_purchase_shipping_charges">
                                <i class="fa fa-refresh fa-spin fa-fw"></i>
                            </span>
                        </td>
                    </tr>
        ...
        <div class="col-xs-6">
            @component('components.widget')
                <table class="table table-striped">
                    <tr>
                        <th>{{ __('report.closing_stock') }} (By purchase Price):</th>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="closing_stock_by_sell">
                                <i class="fa fa-refresh fa-spin fa-fw"></i>
                            </span>
                        </td>
                    </tr>
    ...
    <div class="row">
        <div class="col-xs-12">
            @component('components.widget')
                ...
                <small class="help-block">(@lang('report.closing_stock') + @lang('home.total_sell') + @lang('report.total_stock_recovered') + @lang('lang_v1.total_purchase_return') + @lang('lang_v1.total_purchase_discount') + total Income) <br> - (@lang('report.opening_stock') + @lang('home.total_purchase') + @lang('report.total_stock_adjustment') + @lang('report.total_expense')  + @lang('lang_v1.total_shipping_charges') + @lang('lang_v1.total_sell_discount') + @lang('lang_v1.total_sell_return'))</small>
            @endcomponent
        </div>
    </div>
