<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => route('contacts.update', [$contact->id]), 'method' => 'PUT', 'id' => 'contact_edit_form']) !!}
    ...
    <div class="modal-body">
      ...
      <div class="col-md-3">
        <div class="form-group">
            ...
            {!! Form::text('first_name', $user ? $user->first_name :null, ['class' => 'form-control',
      ...
      <div class="col-md-3">
        <div class="form-group">
            ...
            {!! Form::text('last_name', $user ? $user->last_name :null, ['class' => 'form-control',
      ...
      <div class="col-md-3">
            <div class="form-group">
              {!! Form::label('role', __( 'user.role' ) . ':*') !!}
                {!! Form::select('role', $roles, $user?$user->roles->first()->id :null, ['class' => 'form-control select2']); !!}
            </div>
        </div>
      ...
      <div class="col-md-3">
        <div class="form-group">
            ...
            {!! Form::text('username', $user ? $user->username :null, ['class' => 'form-control',
                'placeholder' => __('User Name'),'required',$user?'disabled':'']); !!}
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
            {!! Form::label('password', __('Password') . ':') !!}
           {!! Form::password('password', ['class' => 'form-control', $user ?'':'required', 'placeholder' => __( 'business.password' ) ]); !!}
        </div>
      </div>
