  ...
  @endphp
    ...
    <div class="modal-body">
      ...
      <div class="col-md-4">
        ...
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('vat', 'National ID:') !!}
                {!! Form::text('national_id', null, ['class' => 'form-control', 'placeholder' => 'Enter National ID Number']) !!}
            </div>
        </div>
      ...
      <div class="col-md-3">
        <div class="form-group">
          {!! Form::label('role', __( 'user.role' ) . ':*') !!}
            {!! Form::select('role', $roles, null, ['class' => 'form-control select2','required']); !!}
        </div>
      </div>
