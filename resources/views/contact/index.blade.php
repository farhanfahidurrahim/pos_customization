                ...
                @slot('tool')
                    <div class="box-tools">
                        <button type="button" class="btn btn-block btn-primary btn-modal"
                            data-href="{{ route('contacts.create', ['type' => $type]) }}" data-container=".contact_modal">
                    ...
                    <table class="table table-bordered table-striped" id="contact_table">
                        ...
                        <tfoot>
                            <tr class="bg-gray font-17 text-center footer-total">
                                <td
                                    @if ($type == 'supplier') colspan="7" @elseif($type == 'customer') colspan="6" @endif>
                                ...
                                <td><span class="display_currency" id="footer_contact_balance"
                                        data-currency_symbol="true"></span></td>
                                <td></td>
                            </tr>
                        </tfoot>
