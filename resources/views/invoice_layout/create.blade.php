...
@section('content')
    ...
    <section class="content">
        {!! Form::open([
            'url' => route('invoice-layouts.store'),
            'method' => 'post',
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('quotation_heading', 'Quotation', [
                                'class' => 'form-control',
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('invoice_no_prefix', 'Invoice No.', [
                                'class' => 'form-control',
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('quotation_no_prefix', 'Quotation No.', [
                                'class' => 'form-control',
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('date_label', 'Date', ['class' => 'form-control', 'placeholder' => __('lang_v1.date_label')]) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('customer_label', 'Customer', [
                                'class' => 'form-control',
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('table_product_label', 'Product', [
                                'class' => 'form-control',
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('table_qty_label', 'Quantity', [
                                'class' => 'form-control',
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('table_unit_price_label', 'Unit Price', [
                                'class' => 'form-control',
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('table_subtotal_label', 'Subtotal', [
                                'class' => 'form-control',
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('sub_total_label', 'Subtotal', [
                                'class' => 'form-control',
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('discount_label', 'Discount', [
                                'class' => 'form-control',
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('tax_label', 'Tax', ['class' => 'form-control', 'placeholder' => __('invoice.tax_label')]) !!}
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('total_label', __('invoice.total_label') . ':') !!}
                            {!! Form::text('total_label', 'Total', ['class' => 'form-control', 'placeholder' => __('invoice.total_label')]) !!}
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('total_due_label', __('invoice.total_due_label') . ' (' . __('lang_v1.current_sale') . '):') !!}
                            {!! Form::text('total_due_label', 'Total Due', [
                                'class' => 'form-control',
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('paid_label', 'Total Paid', [
                                'class' => 'form-control',
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('prev_bal_label', 'All Balance Due', [
                                'class' => 'form-control',
                                'placeholder' => __('invoice.total_due_label'),
                            ]) !!}
                        </div>
