...
<section class="content no-print">
	{!! Form::open(['url' => route('stock-transfers.store'), 'method' => 'post', 'id' => 'stock_transfer_form' ]) !!}
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						{!! Form::select('location_id', $business_locations, 1, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required', 'id' => 'location_id']); !!}
					</div>
				</div>
