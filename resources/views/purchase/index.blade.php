    ...
    @component('components.filters', ['title' => __('report.filters')])
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                {!! Form::select('purchase_list_filter_payment_status', ['paid' => __('lang_v1.paid'), 'due' => __('lang_v1.due'), 'partial' => __('lang_v1.partial')], 'paid', ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
            </div>
        </div>
