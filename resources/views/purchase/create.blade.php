...
<section class="content">
	...
	{!! Form::open(['url' => route('purchases.store'), 'method' => 'post', 'id' => 'add_purchase_form', 'files' => true ]) !!}
			...
			<table class="table">
				...
				<tr>
					<td class="">
						...
						{!! Form::text('tax_amount', 0, ['id' => 'tax_amount','class'=>'form-control']); !!}
						</div>
					</td>
					<td>&nbsp;</td>
					<td class="">
