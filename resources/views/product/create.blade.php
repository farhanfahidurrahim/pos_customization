            ...
            <div class="row">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button" @if (!auth()->user()->can('brand.create')) disabled @endif
                                    ...
                                    data-href="{{ route('brands.create', ['quick_add' => true]) }}" title="@lang('brand.add_brand')"
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button" @if (!auth()->user()->can('unit.create')) disabled @endif
                                    class="btn btn-default bg-white btn-flat btn-modal"
                                    data-href="{{ route('units.create', ['quick_add' => true]) }}" title="@lang('unit.add_unit')"
                                    data-container=".view_modal"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
                            </span>
                        </div>
                ...
                <div class="col-sm-4 @if (!empty($duplicate_product) && $duplicate_product->enable_stock == 0) hide @endif" id="alert_quantity_div">
                    <div class="form-group">
                        ...
                        {!! Form::number(
                            'alert_quantity',
                            !empty($duplicate_product->alert_quantity) ? $duplicate_product->alert_quantity : 1,
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        {!! Form::label('barcode_number', __('Barcode Number') . ':*') !!}
                        {!! Form::text('barcode_number', null, [
                            'class' => 'form-control',
                            'required',
                            'placeholder' => __('Barcode Number'),
                        ]) !!}
                    </div>
                </div>
                <div class="col-sm-4">
