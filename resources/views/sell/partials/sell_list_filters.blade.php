<div class="col-md-3">
    <div class="form-group">
        {!! Form::label('sell_list_filter_user_id', 'User :') !!}

        {!! Form::select('sell_list_filter_user_id', $users, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all') ]); !!}
    </div>
</div>
<div class="col-md-3">
    <div class="form-group">
