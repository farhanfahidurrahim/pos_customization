...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	{!! Form::open(['url' => route('pos.store'), 'method' => 'post', 'id' => 'add_sell_form' ]) !!}
	<div class="row">
		<div class="col-md-12 col-sm-12">
			@component('components.widget', ['class' => 'box-primary'])
				...
				<div class="col-sm-3">
					<div class="form-group">
						{!! Form::label('sell_status', __('Order Status') . ':*') !!}
						<select name="sell_status" class="form-control select2" required>
				...
				<div class="col-sm-3">
					<div class="form-group">
						{!! Form::label('Refe No', __('Reference No:') . ':*') !!}
						{!! Form::text('ref_no', null, ['class' => 'form-control','placeholder' => __('Reference No:')]); !!}
					</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						{!! Form::text('invoice_no', null, ['class' => 'form-control','placeholder' => __('Invoice Number')]); !!}
						<span>Keep Blank To Auto Generate</span>
						</div>
				</div>
				...
				<div class="col-sm-10 col-sm-offset-1">
					<div class="form-group">
						<div class="input-group">
							...
							<span class="input-group-btn">
								<button type="button" class="btn btn-default bg-white btn-flat pos_add_quick_product" data-href="{{ route('products.quickAdd') }}" data-container=".quick_add_product_modal"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
							</span>
						</div>
					</div>
				</div>
			    ...
			    <div class="col-md-4">
			    	<div class="form-group">
			            ...
			            <div class="input-group">
							...
							<input type="text" name="tax_calculation_amount" id="tax_calculation_amount" class="form-control"
