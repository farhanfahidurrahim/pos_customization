...
@section('content')
    ...
    <section class="content">
        ...
        {!! Form::open([
            'url' => route('pos.update', ['id' => $transaction->id]),
            'method' => 'put',
            'id' => 'edit_sell_form',
        ]) !!}
                ...
                @component('components.widget', ['class' => 'box-primary'])
                        ...
                        <div class="form-group">
                            ...
                            <select name="sell_status" class="form-control select2" required>
                                ...
                                @foreach ($items as $key => $v)
                                    <option value="{{ $key }}"
                                        {{ $key == $transaction->sell_status ? 'selected' : '' }}>{{ $key }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('ref_no', $transaction->ref_no, [
                                'class' => 'form-control',
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="tax_calculation_amount" id="tax_calculation_amount"
                                    class="form-control" value="{{ $transaction->tax_amount }}"
                                    data-default="{{ $transaction->tax_amount }}">
                            </div>
                        </div>
                    </div>
