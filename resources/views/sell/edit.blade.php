			...
			@component('components.widget', ['class' => 'box-primary'])
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<select name="sell_status" class="form-control select2" required>
						    ...
						    <option value="{{$key}}" {{($key== $transaction->sell_status) ? 'selected' :''}}>{{ $key}}</option>
						    @endforeach
						</select>
					</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						{!! Form::text('ref_no', $transaction->ref_no, ['class' => 'form-control','placeholder' => __('Reference No:')]); !!}
					</div>
				</div>
				...
				<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-3 @endif">
					<div class="form-group">
						...
						{!! Form::text('invoice_no', $transaction->invoice_no, ['class' => 'form-control','placeholder' => __('Invoice Number')]); !!}
			     ...
			     <div class="col-md-4">
			    	<div class="form-group">
			            ...
			            <div class="input-group">
							...
							value="{{$transaction->tax_amount}}" data-default="{{$transaction->tax_amount}}">
			            </div>
			        </div>
			    </div>
