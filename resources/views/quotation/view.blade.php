...
<div class="info-table" id="toprint">
    <div class="order-addresses">
        ...
        <table class="order-info">
            <tbody>
                <tr>
                    <td colspan="2" style="text-align: center; background: #0a5fa2;"><h1 style="margin-bottom: 0; color: white; font-weight: 500;">QUOTATION</h1></td>
                </tr>
                <tr>
                    <th style="width: 40%; text-align:left;">Quotation No</th>
                ...
                <tr>
                    <th style="text-align:left;">Vailidty till</th>
                    <td>{{ date("d M, Y", strtotime($quotation->quotation_validity_date))}}</td>
                </tr>
                <tr>
                    <th style="text-align:left;">Client ID</th>
                    <td>{{ $quotation->custom_client_id}}</td>
                </tr>
            </tbody>
        </table>
    </div>
