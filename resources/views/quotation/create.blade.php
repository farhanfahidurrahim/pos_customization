@extends('layouts.app')
@section('title', __('Quotation Create'))
...
<section class="content no-print">
	<div class="card height-auto">
		...
		<form method="POST" action="{{ route('quotations.store') }}" class="new-added-form " enctype="multipart/form-data">
			{{ csrf_field()}}
		<div class="row">
				...
				<div class="col-md-7">
					<div class="row">
						<div class="col-12 form-group">
							<textarea class="form-control" name="company_name" value="" placeholder="Company Name" class="form-control"></textarea>
						</div>
						<div class="col-12 form-group">
							<textarea class="form-control" name="fromany_activity" value="" placeholder="Activity Details" class="form-control"></textarea>
						</div>
						<div class="col-12 form-group">
							<textarea class="form-control" name="fropany_address" id="validationTextarea" placeholder="Address" required=""></textarea>
						</div>
						<div class="col-12 form-group">
							<textarea class="form-control" name="phone" id="validationTextarea" placeholder="Phone" required=""></textarea>
						</div>
						<div class="col-12 form-group">
							<input type="email" name="fompany_email" value="" placeholder="Email" class="form-control">
						</div>
					</div>
				</div>
					...
					<div class="table-responsive">
						...
						<tbody>
							...
							<tr>
								<td>Quotation No</td>
								<td>
									<input type="text" name="quotation_no" value="" class="form-control" required="" placeholder="" value="" />
								</td>
							</tr>
							<tr>
								<td>Date</td>
								<td>
									<input type="date" name="quotation_date" value="" placeholder="dd/mm/yy" class="form-control air-datepicker" data-position="bottom right">
								</td>
							</tr>
							<tr>
								<td>Vailidty till</td>
								 <td>
									<input name="quotation_validity_date" value="" type="date" placeholder="dd/mm/yy" class="form-control air-datepicker" data-position="bottom right">
								</td>
							</tr>
							<tr>
								<td>Client ID</td>
								<td>
									<input type="text" name="custom_client_id" value="" class="form-control" placeholder="" value="" />
								</td>
							</tr>
						</tbody>
					</table>
			...
			<div class="col-md-12 p-3">
				...
				<div class="col-md-6">
					<div class="customer col-md-12">
						...
						<div class="form-group">
							<input type="text" name="email_subject" value="" placeholder="subject details" class="form-control">
						</div>
					</div>
						...
						<div class="row footer">
							<p>
								...
								<div class="col-md-4 form-group">
									<input name="created_name_phone" value="" type="text" placeholder="Mr. Milon - 01728817223" class="form-control">
									<br />
								</div>
