<div class="pos-tab-content">
     <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                @php
                    $sales_invoice_prefix = !empty($business->ref_no_prefixes['sales_invoice']) ? $business->ref_no_prefixes['sales_invoice'] : '';
                @endphp
                {!! Form::label('ref_no_prefixes[sales_invoice]', __('Sales Invoice') . ':') !!}
                {!! Form::text('ref_no_prefixes[sales_invoice]', $sales_invoice_prefix, ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                @php
                    $payemnt_received_prefix = !empty($business->ref_no_prefixes['payemnt_received']) ? $business->ref_no_prefixes['payemnt_received'] : '';
                @endphp
                {!! Form::label('ref_no_prefixes[payemnt_received]', __('Payment Received') . ':') !!}
                {!! Form::text('ref_no_prefixes[payemnt_received]', $payemnt_received_prefix, ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                @php
                    $customer_id_prefix = !empty($business->ref_no_prefixes['customer_id']) ? $business->ref_no_prefixes['customer_id'] : '';
                @endphp
                {!! Form::label('ref_no_prefixes[customer_id]', __('Customer ID') . ':') !!}
                {!! Form::text('ref_no_prefixes[customer_id]', $customer_id_prefix, ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                @php
                    $quoatation_prefix = !empty($business->ref_no_prefixes['quoatation']) ? $business->ref_no_prefixes['quoatation'] : '';
                @endphp
                {!! Form::label('ref_no_prefixes[quoatation]', __('Quoatation') . ':') !!}
                {!! Form::text('ref_no_prefixes[quoatation]', $quoatation_prefix, ['class' => 'form-control']); !!}
            </div>
        </div>
    </div>
</div>
