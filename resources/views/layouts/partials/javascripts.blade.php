...
<script src="{{ asset('framework/plugins/pace/pace.min.js?v=' . $asset_v) }}"></script>

<!-- jQuery 2.2.3 -->
<script src="{{ asset('framework/plugins/jQuery/jquery-2.2.3.min.js?v=' . $asset_v) }}"></script>
...
<!-- iCheck -->
<script src="{{ asset('framework/plugins/iCheck/icheck.min.js?v=' . $asset_v) }}"></script>
<!-- Select2 -->
<script src="{{ asset('framework/plugins/select2/select2.full.min.js?v=' . $asset_v) }}"></script>
<!-- Add language file for select2 -->
@if(file_exists(public_path('framework/plugins/select2/lang/' . session()->get('user.language', config('app.locale')) . '.js')))
    <script src="{{ asset('framework/plugins/select2/lang/' . session()->get('user.language', config('app.locale') ) . '.js?v=' . $asset_v) }}"></script>
@endif
<!-- bootstrap datepicker -->
<script src="{{ asset('framework/plugins/datepicker/bootstrap-datepicker.min.js?v=' . $asset_v) }}"></script>
<!-- DataTables -->
<script src="{{ asset('framework/plugins/DataTables/datatables.min.js?v=' . $asset_v) }}"></script>

<script src="{{ asset('framework/plugins/DataTables/pdfmake-0.1.32/pdfmake.min.js?v=' . $asset_v) }}"></script>
<script src="{{ asset('framework/plugins/DataTables/pdfmake-0.1.32/vfs_fonts.js?v=' . $asset_v) }}"></script>
...
<script src="{{ asset('framework/plugins/daterangepicker/moment.min.js?v=' . $asset_v) }}"></script>

<script src="{{ asset('plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js?v=' . $asset_v) }}"></script>

<script src="{{ asset('framework/plugins/daterangepicker/daterangepicker.js?v=' . $asset_v) }}"></script>

<script src="{{ asset('framework/plugins/ckeditor/ckeditor.js?v=' . $asset_v) }}"></script>
...
<!-- Scripts -->
<script src="{{ asset('js/framework-app.js?v=' . $asset_v) }}"></script>
